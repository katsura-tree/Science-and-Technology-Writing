...
건국대학교 과학기술글쓰기 과목에서 쓴 글 모음입니다. 각 글 폴더에는 원고지 원본 사진과 텍스트로 옮긴 본문·상호 첨삭이 함께 들어 있습니다.
...
문체 가이드를 바탕으로 Claude가 쓴 글과, Claude 초안을 작성자가 다듬은 글입니다. Claude의 문장이 섞여 있어 문체 기준에는 넣지 않습니다.

| # | 글 | 작성 |
|---|---|---|
| 1 | [가장 분하고 억울했던 순간](drafts/01-most-unfair-moment.md) | Claude 초안 → 작성자가 다듬음 |
